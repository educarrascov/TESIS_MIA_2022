...
- [Reporte SPSS experimentos 3*3 - ANOVA - Regression Equations - Paretto Chart - Normal Probability Plot.](https://github.com/educarrascov/TESIS_MIA_2022/blob/main/Reporte.pdf)
 
_________
## Análisis T-TEST de medias poblacionales (Pareadas):

- [Script T-TEST con comparación de medias poblacionales dependientes (pareadas) - Resultado de experimentos.](https://github.com/educarrascov/TESIS_MIA_2022/blob/main/Script/t_test_tesis_sma_centralizado.ipynb)
